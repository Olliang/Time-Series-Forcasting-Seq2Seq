...
I would list out the features I used in this seq2seq model for a more completed picturing of what we are working on here. But if you are curious about or want to recreate the features by your own, please reach out to me for scripts and more information about it (since they are created by my colleagues in my team).
